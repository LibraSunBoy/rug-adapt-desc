 ...
 * @param isPluginExtension   True if this extension has been deployed in the Plugins folder of the jsx application.
 *
 ...
 * @param systemHighlightColor          The highlight color of the extension panel, if provided by the jsx application. Otherwise, the operating-system highlight color.
 *
 ...
 * Stores information about the jsx capabilities.
 *
 ...
 * <ul>
 * <li>Access information about the jsx application in which an extension is running</li>
...
/**
 * Retrieves jsx capability information for the application
 * in which the extension is currently running.
 *
...
/**
 * Retrieves the list of extensions currently loaded in the current jsx application.
 ...
 * since jsx application may use its self-defined scale factor.
 *
 * Since 4.2.0
 *
 ...
 *
 * @return false when the jsx application does not support this functionality (HostCapabilities.EXTENDED_PANEL_MENU is false).
...
/**
 * Register an interest in some key events to prevent them from being sent to the jsx application.
 *
 * This function works with modeless extensions and panel extensions.
 * Generally all the key events will be sent to the jsx application for these two extensions if the current focused element
 ...
 * in advance to prevent them being sent to the jsx application.
 *
 * Since 6.1.0
 *
